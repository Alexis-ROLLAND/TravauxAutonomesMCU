...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/lib_gpio.o: lib_gpio.c  .generated_files/flags/default/240e8a776061ba16a109343b4e00ef7c3d333e53 .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/lib_gpio.o.d 
	@${RM} ${OBJECTDIR}/lib_gpio.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  lib_gpio.c  -o ${OBJECTDIR}/lib_gpio.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MP -MMD -MF "${OBJECTDIR}/lib_gpio.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off    -mdfp="${DFP_DIR}/xc16"
	
${OBJECTDIR}/lib_test_gpio.o: lib_test_gpio.c  .generated_files/flags/default/d7d8751f910a2b5fe348b4d8d2a6c0233a1d2c .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/lib_test_gpio.o.d 
	@${RM} ${OBJECTDIR}/lib_test_gpio.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  lib_test_gpio.c  -o ${OBJECTDIR}/lib_test_gpio.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MP -MMD -MF "${OBJECTDIR}/lib_test_gpio.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off    -mdfp="${DFP_DIR}/xc16"
	
${OBJECTDIR}/test_gpio_t_main.o: test_gpio_t_main.c  .generated_files/flags/default/724fad6ff1b9283627f790dac061726c2e972053 .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/test_gpio_t_main.o.d 
	@${RM} ${OBJECTDIR}/test_gpio_t_main.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  test_gpio_t_main.c  -o ${OBJECTDIR}/test_gpio_t_main.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MP -MMD -MF "${OBJECTDIR}/test_gpio_t_main.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off    -mdfp="${DFP_DIR}/xc16"
